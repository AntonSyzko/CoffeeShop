    ...
    <section id="payments">
        <div class="row payments">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <h3 class="intro-text">
                    <img id = "label-payments" src="/resources/img/section_icon_4.png" width="90px" height="90px"
                         alt="Anton Coffee || Online  coffee shop">
                    <div class="text-shadow">
                        <span class="home-block-name color-green">Payment</span>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 icon-block-payment-delivery">
                ...
                <p class="icon-text">Pay courier</p>
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 icon-block-payment-delivery">
                <i class="fa fa-truck fa-5x color-green" id="icon5"></i>
                <p class="icon-text">Pay to courier <br>DHL</p>
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 icon-block-payment-delivery">
                <i class="fa fa-cc-visa fa-5x color-green" id="icon6"></i>
                <p class="icon-text">CREDIT/DEBIT CARD</p>
            </div>
