            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <h3 class="intro-text">
                    <img id="label-category" src="/resources/img/section_icon_1.png" width="90px" height="90px"
                         alt="Anton Coffee || Online Cofee Shop">
                    <div class="text-shadow">
                        <span class="home-block-name color-green">Categories</span>
                        <span class="home-block-name color-brown"> Coffee</span>
            ...
            <c:if test="${fn:length(categories) gt 0}">
                <c:forEach items="${categories}" var="category">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        <div class="category">
                            <a href="/category_${category.url}" title="Go to category  ${category.title}">
                ...
                <div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1">
                    <h4 class="text-all-products text-shadow">
                        <a href="/all_products" title="Go to all items">Full Coffee Range</a>
                    </h4>
                </div>
            </c:if>
        </div>
