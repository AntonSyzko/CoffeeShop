...
<div class="row">
    <form action="/checkout" method="post">
        ...
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 input-padding text-center">
            <input id="phone" class="input" type="text" name="user_phone" placeholder=" Enter phone"
                   required>
        </div>
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 input-padding text-center">
            <input class="input" type="email" name="user_email" placeholder=" Enter Email"
                   minlength="5" maxlength="50">
        </div>
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 input-padding text-center">
            <input type="submit" class="btn btn-success" value="Confirm order" width="80px">
        </div>
    </form>
</div>
