...
<head>
    ...
    <meta name="title" content="Shopping basket || Anton Coffee">
    <meta name="robots" content="index,follow">
    <title>Shopping basket || Anton Coffee</title>
</head>
<body>
        ...
        <div class="row cart">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1">
                <div class="row section-name text-shadow color-brown">
                    <b>
                        <span class="color-brown">Shopping basket</span>
                        <!-- EMPTY CART -->
                        <c:if test="${fn:length(sale_positions) eq 0}">
                            <span class="color-green"> - empty list!</span>
                        </c:if>
                    </b>
                </div>
            </div>
            ...
            <c:if test="${fn:length(sale_positions) gt 0}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1 text-center">
                        ...
                        <a href="/cart_clear">
                            <button class="btn btn-success">Clera basket</button>
                        </a>
                    </div>
                </div>
            </c:if>
